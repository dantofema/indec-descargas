...
/** Cierra BUS-R2 de `docs/reglas/buscador.md`: los términos se buscan sueltos, y tienen que estar todos. */
...
describe('buscar por código (BUS-R5)', () => {
  ...
  /** Cierra BUS-R4 de `docs/reglas/buscador.md`: los resultados salen en cinco niveles, del match más literal al más laxo. */
